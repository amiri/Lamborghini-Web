# This Makefile is for the Lamborghini::Web extension to perl.
#
...
#     AUTHOR => q[]
#     BUILD_REQUIRES => { Test::More=>q[0], Test::Moose=>q[0], ExtUtils::MakeMaker=>q[6.42] }
#     DISTNAME => q[Lamborghini-Web]
...
# These definitions are from config.sh (via /home/amiri/local/lib/perl5/5.12.1/x86_64-linux-thread-multi/Config.pm).
...
OBJ_EXT = .o
OSNAME = linux
OSVERS = 2.6.32-24-generic
RANLIB = :
SITELIBEXP = /home/amiri/local/lib/perl5/site_perl/5.12.1
SITEARCHEXP = /home/amiri/local/lib/perl5/site_perl/5.12.1/x86_64-linux-thread-multi
SO = so
VENDORARCHEXP = 
VENDORLIBEXP = 
...
PERLMAINCC = $(CC)
PERL_INC = /home/amiri/local/lib/perl5/5.12.1/x86_64-linux-thread-multi/CORE
...
MAKEMAKER   = /home/amiri/local/lib/perl5/5.12.1/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.56
MM_REVISION = 65600
...
MAKE = make
FULLEXT = Lamborghini/Web
BASEEXT = Web
PARENT_NAME = Lamborghini
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Lamborghini/Web.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
O_FILES  = 
H_FILES  = 
MAN1PODS = script/lamborghini_web_cgi.pl \
	script/lamborghini_web_create.pl \
	script/lamborghini_web_fastcgi.pl \
	script/lamborghini_web_server.pl \
	script/lamborghini_web_test.pl
MAN3PODS = 
...
INST_LIBDIR      = $(INST_LIB)/Lamborghini
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Lamborghini
...
DISTNAME = Lamborghini-Web
DISTVNAME = Lamborghini-Web-0.01
...
manifypods : pure_all  \
	...
	script/lamborghini_web_fastcgi.pl \
	script/lamborghini_web_test.pl \
	script/lamborghini_web_cgi.pl \
	script/lamborghini_web_create.pl
	$(NOECHO) $(POD2MAN) --section=1 --perm_rw=$(PERM_RW) \
	  script/lamborghini_web_server.pl $(INST_MAN1DIR)/lamborghini_web_server.pl.$(MAN1EXT) \
	  script/lamborghini_web_fastcgi.pl $(INST_MAN1DIR)/lamborghini_web_fastcgi.pl.$(MAN1EXT) \
	  script/lamborghini_web_test.pl $(INST_MAN1DIR)/lamborghini_web_test.pl.$(MAN1EXT) \
	  script/lamborghini_web_cgi.pl $(INST_MAN1DIR)/lamborghini_web_cgi.pl.$(MAN1EXT) \
	  script/lamborghini_web_create.pl $(INST_MAN1DIR)/lamborghini_web_create.pl.$(MAN1EXT) 
...
EXE_FILES = script/lamborghini_web_cgi.pl script/lamborghini_web_create.pl script/lamborghini_web_fastcgi.pl script/lamborghini_web_server.pl script/lamborghini_web_test.pl

pure_all :: $(INST_SCRIPT)/lamborghini_web_server.pl $(INST_SCRIPT)/lamborghini_web_fastcgi.pl $(INST_SCRIPT)/lamborghini_web_test.pl $(INST_SCRIPT)/lamborghini_web_cgi.pl $(INST_SCRIPT)/lamborghini_web_create.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/lamborghini_web_server.pl $(INST_SCRIPT)/lamborghini_web_fastcgi.pl \
	  $(INST_SCRIPT)/lamborghini_web_test.pl $(INST_SCRIPT)/lamborghini_web_cgi.pl \
	  $(INST_SCRIPT)/lamborghini_web_create.pl 

$(INST_SCRIPT)/lamborghini_web_server.pl : script/lamborghini_web_server.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/lamborghini_web_server.pl
	$(CP) script/lamborghini_web_server.pl $(INST_SCRIPT)/lamborghini_web_server.pl
	$(FIXIN) $(INST_SCRIPT)/lamborghini_web_server.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/lamborghini_web_server.pl

$(INST_SCRIPT)/lamborghini_web_fastcgi.pl : script/lamborghini_web_fastcgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/lamborghini_web_fastcgi.pl
	$(CP) script/lamborghini_web_fastcgi.pl $(INST_SCRIPT)/lamborghini_web_fastcgi.pl
	$(FIXIN) $(INST_SCRIPT)/lamborghini_web_fastcgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/lamborghini_web_fastcgi.pl

$(INST_SCRIPT)/lamborghini_web_test.pl : script/lamborghini_web_test.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/lamborghini_web_test.pl
	$(CP) script/lamborghini_web_test.pl $(INST_SCRIPT)/lamborghini_web_test.pl
	$(FIXIN) $(INST_SCRIPT)/lamborghini_web_test.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/lamborghini_web_test.pl

$(INST_SCRIPT)/lamborghini_web_cgi.pl : script/lamborghini_web_cgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/lamborghini_web_cgi.pl
	$(CP) script/lamborghini_web_cgi.pl $(INST_SCRIPT)/lamborghini_web_cgi.pl
	$(FIXIN) $(INST_SCRIPT)/lamborghini_web_cgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/lamborghini_web_cgi.pl

$(INST_SCRIPT)/lamborghini_web_create.pl : script/lamborghini_web_create.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/lamborghini_web_create.pl
	$(CP) script/lamborghini_web_create.pl $(INST_SCRIPT)/lamborghini_web_create.pl
	$(FIXIN) $(INST_SCRIPT)/lamborghini_web_create.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/lamborghini_web_create.pl
...
TEST_FILE = test.pl
TEST_FILES = t/00db.t t/01app.t t/02pod.t t/03podcoverage.t t/04class_sanity.t t/05strict.t t/controller_Gallery.t t/controller_Submission.t t/view_TT.t
TESTDB_SW = -d
